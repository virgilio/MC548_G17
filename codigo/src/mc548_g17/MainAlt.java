...
public class MainAlt {
    ...
    public static void main(String[] args) {
        ...
        if (args.length < 1) {
            ...
            System.out.println("Utilzando algoritmo alternativo de geracao de vizinhanca: " + Annealing.class.getCanonicalName() + "::gerarVizinhanca2");
            ...
            while (((currTime - initTime) < 60000)) {
                while (L1 < lim1) {
                    while (L2 < lim2) {
                        ...
                        Annealing.gerarVizinhanca2(inst, curr, neig);
